...
if __name__ == '__main__':
    ...
    sortedenv = sorted([x for x in final_df.columns.values if "nv" in x], key=keysort)
    sorted_cols = [c for c in final_df.columns.values if c not in sortedenv] + sortedenv
